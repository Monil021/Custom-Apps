frappe.ui.form.on('Customer Request Form', {   
 ...
 after_cancel: function(frm){
        frm.set_value('customer_code_generated', null);
        frm.refresh_field('customer_code_generated');
        frm.set_value('remarks', null);
        frm.refresh_field('remarks');
    },
    before_submit: function(frm) {
    if (!frm.doc.customer_code_generated) {
        // Prevent form submission
        frappe.msgprint(__('Customer Code Information Required To Submit The Document.'));
        frappe.validated = false;
    }
}
,
